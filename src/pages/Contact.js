                    ...
                    <div className="row">
                        <div className="col-xl-5 col-lg-6">
                            <div className="contact-form-box shadow-box mb--30">
                                <h3 className="title">Free Growth Consulation</h3>
                                <FormTwo />
                        ...
                        <div className="col-xl-5 col-lg-6 offset-xl-1">
                            <div className="contact-info mb--100 mb_md--30 mt_md--0 mt--150">
                                ...
                                <h4 className="phone-number"><a href="tel:1234567890">(+61) 452 628 909</a></h4>
                            </div>
                            <div className="contact-info mb--30">
                                <h4 className="title">Email</h4>
                                <p>Our support team will get back to you in 1-2 business days.</p>
                                <h4 className="phone-number"><a href="mailto:info@example.com">info@chromnyx.com</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
